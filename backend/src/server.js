...
const checklistTasksRoutes = require('./routes/checklistTasks');
const waterQualityRangesRoutes = require('./routes/waterQualityRanges');
...
app.use('/api/checklist-tasks', checklistTasksRoutes);
app.use('/api/water-quality-ranges', waterQualityRangesRoutes);
