...
import { LayoutDashboard, Droplets, FileText, Calculator, Settings, Menu, Fish, SquareCheck as CheckSquare, HeartPulse } from 'lucide-react';
...
export default function Layout({ children, currentPageName }) {
  ...
  const navigation = [
    { name: 'Dashboard',          icon: LayoutDashboard, page: 'Dashboard' },    { name: 'Water Quality',      icon: Droplets,        page: 'WaterQuality' },
    { name: 'Reports',            icon: FileText,        page: 'Reports' },    { name: 'Calculator',         icon: Calculator,      page: 'TreatmentCalculator' },
