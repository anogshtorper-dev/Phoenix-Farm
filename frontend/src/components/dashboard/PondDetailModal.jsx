...
import { CircleCheck as CheckCircle2, TriangleAlert as AlertTriangle, Calendar, Plus, Truck, RotateCcw, Minus, X } from 'lucide-react';
        ...
        <DialogContent className="max-w-4xl w-full flex flex-col p-0 gap-0 overflow-hidden [&>button]:hidden fixed top-16 md:top-[50%] left-[50%] translate-x-[-50%] md:translate-y-[-50%] translate-y-0 max-h-[calc(100svh-4rem-env(safe-area-inset-bottom))] md:max-h-[90dvh]">
          ...
          <div className="flex-1 overflow-y-auto overscroll-contain px-6 py-4">
            <div className="space-y-6">
              {status === 'outdated' && <Alert><AlertTriangle className="h-4 w-4" /><AlertDescription>This tank is older than its department update threshold</AlertDescription></Alert>}
