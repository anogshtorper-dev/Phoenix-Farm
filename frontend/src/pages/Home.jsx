...
import { Pond, PondGroup, Department } from '@/api';
import { Droplets, TriangleAlert as AlertTriangle, Activity, TrendingUp, ArrowRight } from 'lucide-react';
import { isPondOutdatedByDepartment } from '@/utils/pondStatus';
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
          <Card className="bg-gradient-to-br from-teal-500 to-teal-600 text-white border-0">
            <CardContent className="p-5 md:p-8">
              ...
              <p className="text-teal-50 text-sm md:text-base mb-4 md:mb-6">
                View real-time status of all ponds with color-coded status indicators and detailed metrics
              </p>
          ...
          <Card className="bg-gradient-to-br from-slate-700 to-slate-800 text-white border-0">
            <CardContent className="p-5 md:p-8">
              <h3 className="text-lg md:text-2xl font-bold mb-3 md:mb-4">Review Water Quality</h3>
              <p className="text-slate-300 text-sm md:text-base mb-4 md:mb-6">
                Review measurement history, trends, comparisons, and valid ranges
              </p>
              <Link to={createPageUrl('WaterQuality')}>
