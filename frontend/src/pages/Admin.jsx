...
import ChecklistTasksManagement from '../components/admin/ChecklistTasksManagement';
          ...
          <Tabs defaultValue="departments">
            <div className="overflow-x-auto mb-2">
              <TabsList className="flex w-max min-w-full h-auto gap-1 p-1">
                ...
                <TabsTrigger value="checklist" className="text-xs md:text-sm whitespace-nowrap">Checklist Tasks</TabsTrigger>
              </TabsList>
            </div>
