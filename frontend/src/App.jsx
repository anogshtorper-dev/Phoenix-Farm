      ...
      <AuthProvider>
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/dashboard" element={<AppLayout pageName="Dashboard"><Dashboard /></AppLayout>} />            <Route path="/water-quality" element={<AppLayout pageName="WaterQuality"><WaterQuality /></AppLayout>} />
            <Route path="/reports" element={<AppLayout pageName="Reports"><Reports /></AppLayout>} />            <Route path="/calculator" element={<AppLayout pageName="TreatmentCalculator"><TreatmentCalculator /></AppLayout>} />
